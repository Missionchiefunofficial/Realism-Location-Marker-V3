...
// @match        https://police.operacni-stredisko.cz/*
...
// @downloadURL  https://github.com/Missionchiefunofficial/Realism-Location-Marker-V3/raw/main/realismlocationmarkerv3.user.js
// @updateURL    https://github.com/Missionchiefunofficial/Realism-Location-Marker-V3/raw/main/realismlocationmarkerv3.user.js
...
(function () {
    ...
    var poiTypes = [
        { label: "MissionChief Unofficial Markers Off V3", value: "" },
...
poiLayer = L.geoJson(resultAsGeojson, {
    pointToLayer: function (feature, latlng) {
        ...
        const osmLink = `<a href="https://www.openstreetmap.org/search?query=${latlng.lat}%2C%20${latlng.lng}#map=19/${latlng.lat}/${latlng.lng}" target="_blank">Click here to view on OpenStreetMap</a>`;
                marker.bindPopup(
                    `<b>Coordinates:</b> ${latlng.lat}, ${latlng.lng}<br /><b>Whats here:</b> ${type}<br /><b>Address:</b> Unknown<br /><b>Building:</b> Unknown<br />${osmLink}`
                );
